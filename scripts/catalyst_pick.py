...
# 四字标签库（tag 字段必须从下列里选 1 个，或自创**严格 4 字**且语义清晰的标签）

按事件本质归类——选最贴合的一个：

**政策类**：
- 政策落地 / 文件发布 / 央地共振 / 部委联动 / 试点扩容 / 监管发力

**公司类**：
- 公司公告 / 业绩兑现 / 业绩预增 / 大单中标 / 投建扩产 / 重组复牌 / 增持回购 / IPO 过会

**机构 / 市场类**（保留原设计稿）：
- 机构热评 / 市场热议 / 北向加仓 / 资金抢筹 / 龙头异动

**海外映射类**：
- 海外映射 / 财报传导 / 巨头确认 / 产业共振 / 链条受益

**基本面类（量价信号）**：
- 涨价信号 / 供需缺口 / 出货激增 / 周期反转 / 产能紧张 / 拐点临近 / 需求爆发 / 订单可见
...
- **tag 字段必须严格 4 个汉字**，从标签库选或自创但必须语义精准
