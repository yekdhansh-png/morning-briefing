...
{
  "title": "**字数严格 40-55 字**（约 2.5-3 行），少于 40 字视为不合格。要求把新闻事实完整呈现，让用户只读标题就能掌握核心信息。剥掉'据 XX 报道'/'公告称'等冗余前缀，但**必须保留**：关键主体（谁）+ 关键动作（做了什么）+ 关键事实/数据（结果或影响）。**重要**：早报上方'全球资产表现'已经展示外盘 6 大指数（纳斯达克/标普500/道琼斯/黄金/白银/原油）涨跌幅，所以海外类新闻的 title **避免重复**这些信息——若新闻同时含'三大指数涨跌'和'分化信号'（如某板块逆势）等多个事实，请把'分化信号/海外公司事件/产业新闻'放在 title 主位置，'三大指数涨跌'仅作辅助语带过或不写。例：标题应写'美股光通信逆势走强，Astera Labs涨逾13%，AI 算力链景气度持续映射 A 股光模块板块'，而**不应**写'美股三大指数集体收跌，纳指跌 0.84%，光通信概念股逆势走强'。",
  ...
  "affectedName": "受影响最直接的板块名，≤5 字（如'光通信'/'出口链'/'商业航天'，不要写'XX板块'）",
...
输出：
{
  "title": "中美经贸磋商释放积极信号，双方原则同意对等降税并推进农产品市场准入，外贸链情绪迎修复窗口",
