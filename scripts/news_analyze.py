...
{
  "title": "40-55 字（约 2.5-3 行）。要求把新闻事实完整呈现，让用户只读标题就能掌握核心信息。剥掉'据 XX 报道'/'公告称'等冗余前缀，但**必须保留**：关键主体（谁）+ 关键动作（做了什么）+ 关键事实/数据（结果或影响）。例：'俄罗斯总统普京抵京开启国事访问，中俄在能源、贸易、跨境支付等多领域合作有望加速落地'",
